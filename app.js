...
const diningBarController = require('./controllers/dining-bar');
...
app.get('/amenities', amenitiesController.getAmenities);
app.get('/reservation', reservationController.getReservation);
app.get('/dining-bar', diningBarController.getDiningBar);
